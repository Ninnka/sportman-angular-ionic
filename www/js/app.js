...
angular.module('starter', ['ionic', 'starter.controllers.tab.activity', 'starter.controllers.tab.stadium', 'starter.controllers.tab.find', 'starter.controllers.tab.my', 'starter.controllers.my.setting', 'starter.controllers.common', 'starter.directives', 'starter.services', 'starter.filters', 'starter.states.tab.activity', 'starter.states.tab.stadium', 'starter.states.tab.find', 'starter.states.tab.my', 'starter.states.my.setting', 'starter.states.common', 'ngAnimate', 'ngCordova'])
